		...
		<div class="row">					
            ...
            <div class="col-md-4 ">
                <div class="login-panel panel panel-default" style="border-radius:0px; box-shadow:2px 2px 2px 0px; margin-bottom: 250px;">
                    <div>
                        <h3 align="center"><i class="glyphicon glyphicon-copy"></i>  Register Manager </h3>
                    </div>
					<hr/>
						...
						<div class="panel-body" style="margin-top:-15px;">  
							<fieldset>	
								<div class="form-group">
                                    <label>Name</label>
									<input class="form-control" name="name" type="text"  required placeholder="Type here...">
								</div>							
								
                               <div class="form-group">
                                    <label>Username</label>
									<input class="form-control" name="u" type="text"  required placeholder="Type here...">
								</div>							
								
                                <div class="form-group">
                                    <label>Password</label>
									<input class="form-control" name="p" type="text"  required placeholder="Type here...">
								</div>							
								...
								<?php
									...
									{//1st starts
                                        ...
                                        values('$n','$u','$p')")){
                                            echo "<script>alert('A new manager has been added!')</script>";
                                            echo "<script>window.open('index.php?m','_self')</script>";
										}
										else{
											echo "<script>alert('Error 404! Please try again!')</script>";
										}  
