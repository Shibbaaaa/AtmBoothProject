		...
		<div class="row">					
			<div class="col-md-12">
                <div class="panel">
                    <div class="panel-body" style="padding-bottom:10px;border-radius:0px; box-shadow:2px 2px 4px 0px;">
                        <table class="table table-responsive table-bordered table-hover">
                           ...
                           <tr>
                               ...
                               <td  align="center" ><b>Balance approved by manager</b></td>
                            ...
                            <?php }//while end
                                    ...
                                    echo "
                                    <tr>
                                        <td colspan='5' align='center' style='color:red; font-size:20px;'>No requests from managers at the moment!</td>
                                    </tr>"		;
                                }
                            ?>				
                        </table>   
