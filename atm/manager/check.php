	...
	<body>
       ...
       <nav class="navbar navbar-default navbar-fixed-top">
		...
		<!--
            ...
            ========================
        -->
		<div class="container-fluid" style="background:#54457F; margin-top: 0px; border-radius: 0px; padding-bottom: 390px;">
            <div class="row">
                <br/>
                <div class="col-sm-12" style="text-align:center;">
                    <div class="panel">
                        ...
                        <tr>
							...
							?>
							   <td colspan="3" align="left"  style="background:#444; color:#fff; font-size:20px;"><?php echo ucwords($n[1]); ?>'s  Money Transfer/Cashout Details of <?php echo date('Y'); ?> </td>
							</tr>
							<tr>
							...
							<?php  }?>
							<tr>	
								<td colspan="" class="bg-danger" ><h5 align="center">Approved Balance: <?php echo $n['g_amt']; ?> </h5></td>
								<td colspan="" class="bg-success" ><h5 align="center">Remaining Amount: <?php echo $n['amt'];?></h5></td>
								<td colspan="" class="bg-info" ><h5 align="center">Total amount withdrawn: Tk. <?php echo $t?> /=</h5></td>
							</tr>
                                <tr>
                                    <td colspan="9">
