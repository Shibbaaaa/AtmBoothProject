...
<html>		    
	...
	<body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="home.php"><i class="glyphicon glyphicon-list-alt"></i><b> Home </b></a>
				</div>
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						<li><a href="add_cus.php"><span class='glyphicon glyphicon-copy'></span><b> Register Customer</b></a></li>
                        <li><a href="request.php"><span class='glyphicon glyphicon-edit'></span><b> Request(s) made by customer(s)</b></a></li>
                    </ul>
		...
		<div class="container-fluid" style="background:#B1AAC4; margin-top: 50px; border-radius: 0px;">
			<div class="container">
				<h4>  <i class="glyphicon glyphicon-user"></i> Welcome, <b>Manager <?php echo $t_name?>!</b><span class="pull-right" style="line-height:auto; margin-top: px;"><a></a><i class="glyphicon glyphicon-time	"></i> Date: <?php echo $date = date('d/M/y h:i a'); ?></span></h4> 
			</div>
		</div>
		<!--
            ========================
            ...
            ========================
        -->
        <div class="container-fluid" style="background: #54457F; padding-bottom: 430px;">		
            <div class="row">
                <br/>
                       ...
                       <div class="panel-body" style="border-radius:0px; padding-bottom:0px; box-shadow:2px 2px 2px 0px;">
                           <table align="center" class="table table-bordered table-hover table-striped">
                               ...
                               <tr>	
                                   ...
                                   <td align="center">Tk. <?php echo $u[5]?> /=</td>
